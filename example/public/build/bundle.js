...
var app = (function () {
    ...
    // (25:2) {#each logs as log}
    function create_each_block(ctx) {
    	let t_value = /*log*/ ctx[6] + "";
    	let t;
    	let br;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*logs*/ 4 && t_value !== (t_value = /*log*/ ctx[6] + "")) set_data_dev(t, t_value);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(hr0, "class", "svelte-14lvmun");
    			add_location(hr0, file, 15, 0, 294);
    			attr_dev(div1, "class", "row svelte-14lvmun");
    			add_location(div1, file, 17, 0, 300);
    			attr_dev(hr1, "class", "svelte-14lvmun");
    			add_location(hr1, file, 21, 0, 366);
    			attr_dev(div2, "class", "console svelte-14lvmun");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const consoleLog_handler = e => $$invalidate(2, logs = [...logs, e.detail]);
