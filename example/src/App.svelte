...
<div class="row">
  <div>Default: no range limits, step = 1<br>Current value is {value1}</div> 
  <div class="right">
...
<div class="row">
  <div>Range: 0 - 1000, only horizontal dragging and arrow keys left/right will change the value.<br>Current value is {value2}</div> 
  <div class="right">
...
<div class="row">
  <div>Step = 0.01, precision = 2 decimals<br>Current value is {value3}</div> 
  <div class="right">
...
<div class="row">
  <div>Individual styling using props.<br>Current value is {value4}</div> 
  <div class="right">
...
<div class="row">
  <div>Individual styling using custom class.<br>Current value is {value5}</div> 
  <div class="right">
